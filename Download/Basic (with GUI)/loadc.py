...
def Reload_full():
  import boot_main
def LoadC_info():
  print("LoadC Copyright 2021 by Avery Stafford, this is free software! GNU Free Software License")
  ...
  print("LoadC Booter/Python-Module-LoadC-and-Booter Copyright 2021 by Avery Stafford, this is free software!")
  print("!License Included!")
